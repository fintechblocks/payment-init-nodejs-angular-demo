...
export class BatchInternationalPaymentsComponent implements OnInit {
  ...
  createPaymentBody(paymentFormValue, consentId?) {
        ...
        InternationalScheduledPayments: [
          {
            ...
            Initiation: {
              ...
              ExchangeRateInformation: {
                UnitCurrency: paymentFormValue.scheduledUnitCurrency,
                RateType: paymentFormValue.scheduledRateType
              },
              CurrencyOfTransfer: paymentFormValue.scheduledCurrencyOfTransfer,
              DebtorAccount: {}
            }
          }
        ]
    ...
    if (this.consentDeptorChecked) {
      ...
      body.Data.InternationalScheduledPayments[0].Initiation.DebtorAccount = {
